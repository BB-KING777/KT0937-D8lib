...
/*
// エラーコード
enum KT0937_D8_Error {
  KT0937_D8_Error::OK = 0,
  KT0937_D8_Error::ERROR_I2C,
  KT0937_D8_Error::ERROR_PARAM,
  KT0937_D8_Error::ERROR_TIMEOUT,
  KT0937_D8_Error::ERROR_DEVICE
};
...
// FM空間
enum KT0937_D8_FMSpace {
  KT0937_D8_FMSpace::SPACE_100KHZ = 0,
  KT0937_D8_FMSpace::SPACE_200KHZ,
  KT0937_D8_FMSpace::SPACE_50KHZ
};

// AM空間
enum KT0937_D8_AMSpace {
  KT0937_D8_AM_SPACE_1KHZ = 0,
  KT0937_D8_AM_SPACE_9KHZ,
  KT0937_D8_AM_SPACE_10KHZ
};

// SW空間
enum KT0937_D8_SWSpace {
  KT0937_D8_SW_SPACE_1KHZ = 0,
  KT0937_D8_SW_SPACE_5KHZ,
  KT0937_D8_SW_SPACE_9KHZ,
  KT0937_D8_SW_SPACE_10KHZ
};
*/
// I2C書き込み関数
